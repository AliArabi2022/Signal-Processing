...
yline([sincX(sincX3db) sincX(sincXoct)],'b--',{'MaxSinc','MinSinc'})
YL= yline([butterX(butterX3db) butterX(butterXoct)],'r--',{'MaxButt','MinButt'})
YL(1, 1).LabelHorizontalAlignment = 'center';
YL(2, 1).LabelHorizontalAlignment = 'center';
